        ...
        <Link
          ...
          href={`/${
            props.info.type == "series"
              ...
              : "watch/?vid=" + props.info.video_id+'&time='+get_time(props.info.record&&props.info.record.end_time||0 )
          }`}
          target="_blank"
        >
            ...
            <p className="text-overflow zero-edges fn-size-12">
              {props.info.record.action == "search" && (
                <Link
                  color="inherit"
                  underline="none"
                  href={`/watch/?vid=${props.info.video_id}&time=${get_time(props.info.record.end_time || props.info.record.matched_time||0)}`}
                  target="_blank"
                >
                  搜索
