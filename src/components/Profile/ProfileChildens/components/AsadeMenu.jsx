     ...
     {/** selected={inx == props.info.childpage_id||(props.info.parent=="CreateCenter"&&props.info.childpage_id==3&&inx===0)}*/} 
        {props.menus.map((v, inx) => (
          ...
          <MenuItem
            ...
            data-inx={inx}
            className={inx == props.info.childpage_id||(props.info.parent=="CreateCenter"&&props.info.childpage_id==3&&inx===0)?'fn-color-007CFF':''}
            style={{fontSize:14,paddingLeft:0,margin:'0 -6px',padding:6}}
            onClick={(event) => {
