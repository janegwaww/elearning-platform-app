...
const NotfCon = function () {
  return (
    <div className="all-width contestcar">
      ...
      <div className="grid-context-box" style={{ minHeight: 32, }}>
        <div
          style={{ background: "#D8D8D8", marginBottom: 12, height: 18 }}
        >
        ...
        <div className="grid-avatar" style={{ background: "#D8D8D8", height: 18 }}>
